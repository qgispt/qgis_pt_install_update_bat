:: Name:     qgis_install_update.bat
:: Purpose:  QGIS automatic install and update using osgeo4w-setup.exe
...
:: 3. launch it passing command-line parameters to INSTALL OR UPDATE QGIS FULL
